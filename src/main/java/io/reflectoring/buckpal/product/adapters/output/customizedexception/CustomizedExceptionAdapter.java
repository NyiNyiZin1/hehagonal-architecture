package io.reflectoring.buckpal.product.adapters.output.customizedexception;
...
import io.reflectoring.buckpal.product.adapters.output.customizedexception.data.response.ExceptionResponse;
